...
def display_scoring_ranking(result):
    ...
    with col1:
        ...
        st.plotly_chart(fig1, config={'displayModeBar': False}, width=True)
    ...
    with col2:
        ...
        if len(top10_df) > 0:
            ...
            st.plotly_chart(fig2, config={'displayModeBar': False}, width=True)
...
def display_visualizations(result):
    ...
    if summary.get('top_stocks'):
        ...
        st.plotly_chart(fig, config={'displayModeBar': False}, width=True)
